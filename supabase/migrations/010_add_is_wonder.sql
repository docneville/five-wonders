-- Migration: Add is_wonder to places and rebuild view

ALTER TABLE places
  ADD COLUMN IF NOT EXISTS is_wonder BOOLEAN NOT NULL DEFAULT false;

-- Existing rows stay false — user will bulk-flip via the UI or a later migration.

-- Rebuild view to include is_wonder
